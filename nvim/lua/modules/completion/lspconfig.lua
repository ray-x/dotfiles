...
function auto_group()
  ...
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
      file_types ..
        [[ autocmd nvim_lsp_autos BufWritePre <buffer> silent! lua vim.lsp.diagnostic.set_loclist({open_loclist = false})]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
      file_types .. [[ autocmd nvim_lsp_autos CursorHold  <buffer> silent! lua vim.lsp.buf.document_highlight()]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
      file_types .. [[ autocmd nvim_lsp_autos CursorHoldI <buffer> silent! lua vim.lsp.buf.document_highlight()]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
      file_types .. [[ autocmd nvim_lsp_autos CursorMoved <buffer> lua vim.lsp.buf.clear_references()]]
  )
   --
  ...
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ imap <silent> <m-k>   <cmd>lua vim.lsp.buf.signature_help()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> gs      <cmd>lua vim.lsp.buf.signature_help()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> g0      <cmd>lua vim.lsp.buf.document_symbol()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <leader>g0      <cmd>Vista finder clap<CR>]]
  ) --use clap
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> gW      <cmd>lua vim.lsp.buf.workspace_symbol()<CR>]]
  ) --lsputil or telescope

  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <c-]>   <cmd>lua vim.lsp.buf.definition()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> de      <cmd>lua vim.lsp.buf.declaration()<CR>]]
  ) --?
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <Leader>rn  <cmd>lua vim.lsp.buf.rename()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. format_files .. [[ nnoremap <silent> <Leader>rf <buffer> lua vim.lsp.buf.formatting()]]
  ) --buffer format
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <Leader>gi <buffer> lua vim.lsp.buf.incoming_calls()]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <Leader>go <buffer> lua vim.lsp.buf.outgoing_calls()]]
  )

  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> gD      <cmd>lua vim.lsp.buf.implementation()<CR>]]
  ) --lsputil
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> gt      <cmd>lua vim.lsp.buf.type_definition()<CR>]]
  ) --? no for go
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
      file_types .. [[ nnoremap <silent> gL      <cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] ..
  ...
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> <C-LeftMouse> <cmd>lua vim.lsp.buf.definition()<CR>]]
  )
  vim.api.nvim_command(
    [[autocmd FileType ]] .. file_types .. [[ nnoremap <silent> g<LeftMouse> <cmd>lua vim.lsp.buf.implementation()<CR>]]
  )

  vim.api.nvim_command(
    [[nnoremap <leader>gr <cmd>lua require'telescope.builtin'.lsp_references{ shorten_path = true }<CR>]]
  )
  vim.api.nvim_command(
